...
local ESP_SETTINGS = {
    ...
    SelectedTeams = {},  -- Teams for which ESP should be drawn
}
...
getgenv().isManipulating = false 
getgenv().teamCheck1 = false 
...
local function populateTeamNames()
    local teamNames = {}
...
local teamNames = populateTeamNames()

sections.ESPSection:AddList({
    enabled = true,
    text = "Team", 
    tooltip = "Choose to which teams the ESP will draw on",
    multi = true,
    open = false,
    max = 1,
    values = teamNames,
